...
!define URL http://www.Monroe.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/Monroe.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\Monroe-qt.exe
...
OutFile Monroe-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/Monroe-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/Monroed.exe
    ...
    #Delete /REBOOTOK $INSTDIR\Monroe.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\Monroe-qt.exe
