...
const string strMessageMagic = "Monroe Signed Message:\n";
...
// Monroe: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Monroe", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Monroe";
        CTransaction txNew;
        txNew.nTime = 1507154525;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1507154525;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 462643 : 462643;
        ...
        assert(block.hashMerkleRoot == uint256("0x75d483e50a679d938d3865debf76a1946e30abe34a3d21a52abcf3215120f253"));
...
unsigned char pchMessageStart[4] = { 0x25, 0xd2, 0xc1, 0xe4 };
